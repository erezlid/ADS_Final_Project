...
yield_groups_var_and_mean |>
  ...
  geom_text(x=50000,y=4e+09,label = paste("NB R^2: ", round(1 - fit_nb$deviance/fit_nb$null.deviance, 2))) + 
  geom_text(x=50000, y=4.5e+09, label = paste("QPoi R^2: ", round(1 - fit_qpoi$deviance/fit_qpoi$null.deviance, 3)))
```
