...
Although we have renamed some of the columns on the pre processing procedure, we decided to once again rename the columns so it'd be more easier to work with them:
...
For data analysis efficinecy, we joined all of our tables into one big table:
